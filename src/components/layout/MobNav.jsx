...
/* ==========================================================
   الشريط السفلي: كبسولة متحركة + التنقل بالسحب (إحساس iOS / Telegram)
   - النقر يعمل كما كان، والكبسولة تنزلق للتبويب الجديد
   - السحب على الشريط: الكبسولة تتبع الإصبع وتتمدد قليلاً مع السرعة
   - عند الرفع: تلتصق بأقرب تبويب (وتراعي سرعة الحركة) وتنتقل الصفحة
   - الحركة كلها تتم مباشرة على الـ DOM (بدون setState في كل إطار) لتبقى سلسة
   ========================================================== */
